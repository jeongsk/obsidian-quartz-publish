...
import { QuartzUpgradeService } from "../../../src/entities/quartz/model/upgrade";
import type { GitHubService } from "../../../src/entities/github/model/service";
import type { QuartzUpgradeProgress } from "../../../src/app/types";
...
describe("QuartzUpgradeService", () => {
  ...
  describe("getLatestVersion", () => {
    it("최신 릴리스 태그를 반환한다", async () => {
      ...
      expect(mockGitHub.getLatestRelease).toHaveBeenCalledWith("jackyzha0", "quartz");
    });
  ...
  describe("getUpgradeFiles", () => {
    ...
    it("특정 버전의 파일을 조회할 수 있다", async () => {
      ...
      expect(mockGitHub.getExternalTree).toHaveBeenCalledWith("jackyzha0", "quartz", "v4.0.5");
    });
  });
