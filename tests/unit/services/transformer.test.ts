...
describe("ContentTransformer", () => {
  ...
  describe("transformImageEmbeds", () => {
    ...
    it("should handle multiple images in content", () => {
      ...
      vi.spyOn(metadataCache, "getFirstLinkpathDest").mockImplementation((linkpath: string) => {
  ...
  describe("transformMarkdownImageSize", () => {
    it("should convert ![alt|width](url) to HTML img tag", () => {
      ...
      expect(result.content).toBe(
        '<img src="https://example.com/image.png" alt="alt text" width="500">'
      );
    });
    ...
    it("should convert ![alt|widthxheight](url) to HTML img tag with dimensions", () => {
      ...
      expect(result.content).toBe(
        '<img src="https://example.com/image.png" alt="alt text" width="500" height="300">'
      );
    });
    ...
    it("should handle multiple images with size in content", () => {
      ...
      expect(result.content).toBe(
        'First <img src="url1" alt="img1" width="200"> and second <img src="url2" alt="img2" width="300" height="150">'
      );
    });
...
![image|500](https://example.com/image.png)`;
      ...
      expect(result.content).toContain(
        '<img src="https://example.com/image.png" alt="image" width="500">'
      );
    });
  });
