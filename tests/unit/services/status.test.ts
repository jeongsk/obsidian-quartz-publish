...
import { StatusService, StatusProgressCallback } from '../../../src/services/status';
import { Vault, MetadataCache, TFile } from '../../mocks/obsidian';
import type { PublishRecord, NoteStatus, StatusOverview } from '../../../src/types';
...
describe('StatusService', () => {
	...
	describe('calculateFileStatus()', () => {
		...
		it('publish: false로 변경된 파일을 감지한다', async () => {
			...
			const file = vault._addFile('notes/unpublished-note.md', '---\npublish: false\n---\n# Unpublished');
