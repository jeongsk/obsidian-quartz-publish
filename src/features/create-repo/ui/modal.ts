...
import { RepositoryCreatorService } from "../model/creator";
import type { CreatedRepository } from "../../../app/types";
import { DEFAULT_REPO_NAME } from "../../../app/types";
...
export class CreateRepoModal extends Modal {
  ...
  private renderForm() {
    ...
    const createBtn = buttonContainer.createEl("button", {
      text:
        this.state === "creating" ? t("modal.createRepo.creating") : t("modal.createRepo.create"),
    ...
    if (this.state === "creating") {
      ...
      progressEl.createSpan({
        text: t("modal.createRepo.creatingProgress"),
      });
    }
  }
  ...
  private renderSuccess() {
    ...
    const successIcon = successHeading.createSpan({
      attr: { "aria-hidden": "true" },
    });
