  ...
  private renderEnableSPAToggle(): void {
    new Setting(this.containerEl)
      ...
      .addToggle((toggle) => {
        ...
        toggle.setValue(this.options.config.enableSPA).onChange((value) => {
  ...
  private renderEnablePopoversToggle(): void {
    new Setting(this.containerEl)
      ...
      .addToggle((toggle) => {
        ...
        toggle.setValue(this.options.config.enablePopovers).onChange((value) => {
    ...
    new Setting(this.containerEl)
      ...
      .addDropdown((dropdown) => {
        ...
        dropdown.onChange((value) => {
          this.options.onChange("defaultDateType", value as "created" | "modified" | "published");
        });
      });
  }
