...
import { validateGlobPattern } from "../../../../shared/lib/glob-validator";
...
export class PublishingSection {
  ...
  private renderExplicitPublishToggle(): void {
    new Setting(this.containerEl)
      ...
      .addToggle((toggle) => {
        ...
        toggle.setValue(this.options.config.explicitPublish).onChange((value) => {
   ...
   * 외부에서 값 업데이트
   */
  updateValues(config: Pick<QuartzSiteConfig, "explicitPublish" | "ignorePatterns">): void {
