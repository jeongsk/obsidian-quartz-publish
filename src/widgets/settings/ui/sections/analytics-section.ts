...
import { ANALYTICS_PROVIDERS } from "../../../../shared/config/constants/analytics";
import { t } from "../../../../shared/lib/i18n";
import type { AnalyticsConfig, QuartzSiteConfig } from "../../../../app/types";
import { validateAnalytics } from "../../../../shared/lib/validators";
        ...
        text
          ...
          .onChange((value) => {
            if (this.currentConfig.provider === "umami") {
              const current = this.currentConfig as {
                provider: "umami";
                websiteId: string;
                host: string;
              };
