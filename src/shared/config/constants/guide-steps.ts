...
import type { GuideStep, TroubleshootingItem, SetupStatus } from "../../../app/types";
...
export function createGuideSteps(status?: SetupStatus): GuideStep[] {
  return [
    ...
    },
    {
      ...
      troubleshootingTips: [t("guide.step2.tip1"), t("guide.step2.tip2"), t("guide.step2.tip3")],
    ...
    },
    {
      ...
      troubleshootingTips: [t("guide.step3.tip1"), t("guide.step3.tip2"), t("guide.step3.tip3")],
