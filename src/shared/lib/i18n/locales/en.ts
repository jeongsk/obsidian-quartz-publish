export default {
  ...
  "settings.customCss.contentDesc": "Enter your custom CSS/SCSS code to style your Quartz site.",
  ...
  "dashboard.modified.koreanFilenameWarning":
    "Items with Korean filenames may not be found when clicked. If this happens, please re-publish.",
