...
import type { QuartzFrontmatter, FrontmatterValidationSettings, ValidationIssue } from "../types";
...
export class FrontmatterEditorModal extends Modal {
  ...
  private renderForm(): void {
    ...
    new Setting(formEl)
      ...
      .addToggle((toggle) => {
        toggle.setValue(this.editedFrontmatter.enableToc !== false).onChange((value) => {
  ...
  private updateValidation(): void {
    ...
    const result = this.options.transformer.validateFrontmatter(this.editedFrontmatter, settings);
