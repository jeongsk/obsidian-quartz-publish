...
import { createGuideSteps, createTroubleshootingItems, TOTAL_GUIDE_STEPS } from '../constants/guide-steps';
...
export class GitHubGuideModal extends Modal {
	...
	private renderHeader(container: HTMLElement) {
		...
		const statusBadge = headerContainer.createEl('span', {
			cls: `qp:text-xs qp:px-2 qp:py-1 qp:rounded qp:text-obs-text-[var(--color-base-00)] ${
				isComplete
