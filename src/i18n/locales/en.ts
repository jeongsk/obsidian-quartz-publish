export default {
	...
	"settings.github.repoUrlDesc":
		"Your Quartz repository URL (e.g., https://github.com/user/quartz)",
	"settings.github.branch": "Branch",
	"settings.github.branchDesc":
		"Target branch for publishing (auto-detected on connection test)",
	"settings.github.testConnection": "Test Connection",
	"settings.github.testConnectionDesc":
		"Verify GitHub connection and Quartz repository",
	"settings.github.createRepo": "Create Quartz Repository",
	"settings.github.newToQuartz": "New to Quartz?",
	"settings.github.newToQuartzDesc":
		"Create a new Quartz repository from template",
	...
	"settings.quickLinks.githubDisabled":
		"GitHub Repository (configure repository URL first)",
	"settings.quickLinks.site": "Open Deployed Site",
	"settings.quickLinks.siteDisabled":
		"Deployed Site (configure site URL first)",
	...
	"settings.autoDate.createdDesc":
		"Add file creation date (format: YYYY-MM-DD)",
	"settings.autoDate.modified": "Add modified date",
	"settings.autoDate.modifiedDesc":
		"Add file modification date (format: YYYY-MM-DD)",
	"settings.autoDate.published": "Add published date",
	"settings.autoDate.publishedDesc":
		"Add current date as published date (format: YYYY-MM-DD)",
	"settings.autoDate.title_field": "Auto-add Title",
	"settings.autoDate.title_fieldDesc":
		"Auto-generate title field from filename",
	"settings.autoDate.description_field": "Auto-add Description",
	"settings.autoDate.description_fieldDesc":
		"Auto-generate description field from first paragraph",
	...
	"settings.frontmatter.editorDesc":
		"Show modal to edit frontmatter before publishing",
	"settings.frontmatter.validation": "Enable Validation",
	"settings.frontmatter.validationDesc":
	...
	"settings.frontmatter.requireDescriptionDesc":
		"Warn if description field is missing",
	...
	"settings.comments.reactionsEnabledDesc":
		"Allow reactions on the main post",
	"settings.comments.inputPosition": "Input Position",
	"settings.comments.inputPositionDesc":
	...
	"settings.publishing.explicitPublishDesc":
		"Only publish notes with explicit publish flag",
	"settings.publishing.ignorePatterns": "Ignore Patterns",
	"settings.publishing.ignorePatternsDesc":
		"Glob patterns to ignore when publishing",
	...
	"notice.batch.partial":
		"Published: {{succeeded}} success, {{failed}} failed",
	"notice.delete.success": "{{count}} notes deleted.",
	"notice.delete.partial":
		"Deleted: {{succeeded}} success, {{failed}} failed",
	...
	"notice.network.offline":
		"Please check your internet connection. Network connection is required to publish.",
	...
	"notice.settings.reloaded":
		"Settings reloaded. Please apply your changes again.",
	...
	"notice.customCss.noPath": "Please specify a custom CSS file path",
	"notice.customCss.notFound": "Custom CSS file not found in vault",
	"notice.customCss.success": "Custom CSS uploaded successfully",
	"notice.customCss.failed": "Failed to upload custom CSS: {{error}}",
	"notice.customCss.error": "Error uploading custom CSS: {{message}}",
	...
	"modal.sync.message":
		"Publish {{newCount}} new, {{modifiedCount}} modified and delete {{deleteCount}} notes. Proceed?",
	...
	"modal.conflict.message":
		"The configuration on GitHub has been modified. What would you like to do?",
	...
	"modal.largeFile.message":
		"{{count}} files exceed {{size}}. Large files may cause publishing issues.",
	...
	"modal.largeFile.tip.imageCompression":
		"Consider compressing images or using external hosting.",
	...
	"modal.frontmatter.descriptionDesc":
		"Page description (shown in link previews)",
	...
	"modal.frontmatter.permalinkDesc":
		"Custom URL path (persists even if file moves)",
	...
	"modal.createRepo.nameDesc":
		'Enter a name for your Quartz repository (default: "quartz")',
	"modal.createRepo.visibility": "Visibility",
	"modal.createRepo.visibilityDesc":
		"Public repositories can be hosted free on GitHub Pages",
	"modal.createRepo.public": "Public",
	"modal.createRepo.private": "Private",
	"modal.createRepo.privateWarning":
		"Private repositories require GitHub Pro for GitHub Pages hosting.",
	"modal.createRepo.create": "Create",
	"modal.createRepo.creating": "Creating...",
	"modal.createRepo.creatingProgress":
		"Creating repository from Quartz template...",
	...
	"connection.connected":
		"Connected to {{owner}}/{{name}} (branch: {{branch}})",
	...
	"settings.github.manageFilesDesc":
		"View and delete files from your remote repository",
	...
	"modal.remoteFiles.deletePartial":
		"Deleted {{succeeded}} file(s), {{failed}} failed",
	...
	"modal.remoteFiles.selectFile": "Select {{name}}",

	// Errors - Remote Files
	"error.remoteFiles.loadFailed": "Failed to load file list",
	"error.remoteFiles.maxFiles":
		"Cannot delete more than {{max}} files at once",
	...
	"guide.step2.tip1":
		"Set the Repository name to any name you want (e.g., quartz)",
	...
	"guide.step3.tip2":
		'Select "No expiration" or your preferred duration for Expiration',
	...
	"guide.error.404.cause":
		"The repository URL is incorrect or the repository is private",
	"guide.error.404.solution":
		"Check the URL and verify token permissions if the repository is private",
	...
	"guide.error.network.cause":
		"There is a problem with your internet connection",
	"guide.error.network.solution":
	...
	"behavior.spa.desc":
		"Provides smooth transitions without full page reloads when navigating",
	"behavior.popovers.name": "Link Popovers",
	"behavior.popovers.desc":
		"Shows a preview of linked pages when hovering over internal links",
	"behavior.dateType.name": "Default Date Type",
	"behavior.dateType.desc":
		"Select the default date type to display on notes",
	...
	"deployGuide.step1.desc":
		"Go to your GitHub repository settings page to configure GitHub Pages.",
	...
	"deployGuide.step3.desc":
		'Under "Build and deployment", set the Source to "GitHub Actions". This allows Quartz to automatically deploy when you publish notes.',
	"deployGuide.step4.title": "Enable Workflow Permissions",
	"deployGuide.step4.desc":
		'Go to Settings > Actions > General. Under "Workflow permissions", select "Read and write permissions" to allow the deploy workflow to push to GitHub Pages.',
	"deployGuide.step4.action": "Open Actions Settings",
	"deployGuide.step5.title": "Trigger First Deployment",
	"deployGuide.step5.desc":
		"The deployment will start automatically when you publish your first note. You can also trigger it manually from the Actions tab.",
	"deployGuide.step5.action": "View Actions",
	"deployGuide.step6.title": "Visit Your Site",
	"deployGuide.step6.desc":
		"After deployment completes (usually 2-3 minutes), your Quartz site will be live! Click below to visit your new digital garden.",
	...
	"publishing.explicitPublish.desc":
		'When enabled, only notes with "publish: true" in frontmatter will be published. When disabled, all notes except drafts will be published.',
	"publishing.ignorePatterns.name": "Ignore Patterns",
	"publishing.ignorePatterns.desc":
		"File/folder patterns to exclude from publishing (glob format)",
	...
	"modal.conflict.reload.desc":
		"Load the latest settings and apply your changes again. (Recommended)",
	"modal.conflict.overwrite.title": "Force overwrite",
	"modal.conflict.overwrite.desc":
		"Ignore remote changes and overwrite with current settings.",
	...
	"analytics.plausible.host.desc":
		"Self-hosted Plausible instance URL (defaults to Plausible Cloud)",
